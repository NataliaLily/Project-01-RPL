        ...
        <div class="container-fluid">
            <form action="{{route('post.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" name="post_title" class="form-control" placeholder="Judul Berita">
                        ...
                        <textarea name="post_content" class="form-control" placeholder="Isi Berita"></textarea>
